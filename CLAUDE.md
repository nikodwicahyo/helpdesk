# HelpDesk Kemlu - Project Overview for Claude
...
2. System searches across 4 tables in priority order
...
# Database
php artisan make:migration create_users_table (repeat for all 11 tables)
php artisan migrate
php artisan db:seed
...
This project is in **planning/early development phase**. The comprehensive documentation in PLANNING.md and PRD.md provides detailed implementation guidelines, database schemas, API structures, and UI components ready for development.
...
**Claude Context:** This document provides essential project context for AI assistance