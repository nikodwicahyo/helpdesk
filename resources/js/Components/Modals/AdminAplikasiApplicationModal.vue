                ...
                <div class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        <label for="category" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ t('modal.applicationModal.category') }}
                        </label>
                        <select
                            id="category"
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <dl class="grid grid-cols-2 gap-2 text-sm">
                                <div>
                                    ...
                                    <dd class="font-medium text-gray-900">{{ application.total_tickets || application.ticket_count || 0 }}</dd>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <dd class="font-medium text-gray-900">{{ application.total_categories || application.category_count || 0 }}</dd>
                                </div>
                                <div>
