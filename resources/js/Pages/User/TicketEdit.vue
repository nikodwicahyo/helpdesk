        ...
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update ticket details for {{ ticket.ticket_number }}</p>
                </div>
                <Link
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="bg-white rounded-lg shadow-md">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Update your ticket details</p>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                :class="{'border-red-500': form.errors.aplikasi_id}"
                            >
                            ...
                            <p v-if="form.errors.aplikasi_id" class="mt-1 text-sm text-red-600">
                        ...
                        <div>
                            ...
                            <p v-if="form.errors.kategori_masalah_id" class="mt-1 text-sm text-red-600">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between mt-1">
                                ...
                                <p class="text-sm text-gray-500">{{ form.title.length }}/200</p>
                            </div>
                        </div>
...
const availableCategories = ref(props.categories.filter(cat => cat.aplikasi_id === props.ticket.aplikasi_id));
...
const loadCategories = async () => {
    ...
    try {
        const response = await axios.get(`/api/applications/${form.aplikasi_id}/categories`);
        availableCategories.value = response.data;

        // Reset category if it's not in the new list
        if (!availableCategories.value.find(c => c.id === form.kategori_masalah_id)) {
            form.kategori_masalah_id = '';
        }
    } catch (error) {
