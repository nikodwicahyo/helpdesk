<template>
    <AppLayout role="admin-aplikasi">
            ...
            >
                <div>
                    ...
                    <p class="text-gray-600 mt-2 text-sm">
                        {{ t("modal.categoryModal.createDescription") }}
                    </p>
                </div>
                <div class="flex flex-wrap items-center gap-3">
                    <div
                        class="flex items-center gap-2 bg-white rounded-xl shadow-md px-4 py-2 border border-purple-100"
                    >
                        <svg
                        ...
                        >
                            <option value="">
                                {{ t("modal.categoryModal.selectApplication") }}
                            </option>
                            <option
        ...
        <div
            ...
            class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-xl p-6 mb-6 border border-purple-100 backdrop-blur-sm"
        >
            <div
                class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"
            >
                <div class="flex items-start gap-4">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0"
                    >
                        <svg
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-3 mt-3">
                            <div
                                class="flex items-center gap-1.5 bg-white/70 backdrop-blur-sm rounded-lg px-3 py-1.5 shadow-sm"
                            >
                                <svg
                                ...
                                >
                                    {{
                                        selectedApplication.category_count || 0
                                    }}
                                    {{ t("nav.categories") }}
                                </span>
                            </div>
                            ...
                            >
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-700"
                                >
                                    {{ selectedApplication.ticket_count || 0 }}
                                    {{ t("ticket.totalTickets") }}
                                </span>
                            </div>
                            <span
                                :class="[
                                    'px-3 py-1.5 text-xs font-bold rounded-lg shadow-sm',
        ...
        >
            <!-- Total Categories -->
            <div
                class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-5 text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border border-white/30 relative overflow-hidden"
            >
                ...
                >
                    {{ $t("common.management") }} {{ $t("nav.categories") }}
                </h3>
            ...
            <!-- Active Categories -->
            <div
                class="bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl p-5 text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border border-white/30 relative overflow-hidden"
            >
                <div class="flex items-center justify-between mb-4">
                    <div
                        class="w-12 h-12 bg-white/30 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg"
                ...
                <h3
                    class="text-white text-xs font-semibold mb-2 uppercase tracking-wide opacity-90"
                >
                    {{ $t("status.active") }} {{ $t("nav.categories") }}
                </h3>
                <div class="text-3xl sm:text-4xl font-extrabold drop-shadow-lg">
            ...
            <!-- Total Tickets -->
            <div
                class="bg-gradient-to-br from-yellow-600 to-orange-700 rounded-2xl p-5 text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border border-white/30 relative overflow-hidden"
            >
                <div class="flex items-center justify-between mb-4">
                    <div
                        class="w-12 h-12 bg-white/30 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg"
            ...
            <!-- Open Tickets -->
            <div
                class="bg-gradient-to-br from-red-600 to-rose-700 rounded-2xl p-5 text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border border-white/30 relative overflow-hidden"
            >
                <div class="flex items-center justify-between mb-4">
                    <div
                        class="w-12 h-12 bg-white/30 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg"
        ...
        <div
            v-if="!selectedApplication"
            class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-xl p-12 sm:p-16 text-center border border-purple-100"
        >
            <div
                class="mx-auto w-24 h-24 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-2xl mb-6"
            >
                <svg
            ...
            <div
                class="inline-flex items-center gap-2 text-purple-600 font-medium"
            >
                <svg
                    class="w-5 h-5"
                    fill="none"
                ...
                <span>{{ $t("modal.categoryModal.selectApplication") }}</span>
            </div>
        </div>
        ...
        <div v-else class="space-y-6">
            <!-- Search and Filters -->
            <div
                class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-purple-100"
            >
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justify-center"
                    >
                        <svg
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            />
                            <svg
                                class="absolute left-3.5 top-3 w-5 h-5 text-gray-400 group-hover:text-purple-600 transition-colors"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div v-if="loading" class="p-12 text-center">
                    ...
                    <p class="mt-2 text-gray-500">
                        {{ $t("common.loading") }} {{ $t("nav.categories") }}...
                    </p>
                </div>
                ...
                <div
                    ...
                    class="bg-indigo-50 border border-indigo-200 rounded-lg p-4 m-6"
                >
                    <div class="flex items-center justify-between">
                        <span class="text-indigo-800 font-medium">
                            {{ selectedCategories.length }}
                            {{ $t("nav.categories") }} selected
                        </span>
                        <div class="flex items-center space-x-3">
                            ...
                            >
                                ...
                                <option value="activate">
                                    {{ t("modal.categoryModal.activate") }}
                                    {{ t("nav.categories") }}
                                </option>
                                <option value="deactivate">
                                    {{ t("modal.categoryModal.deactivate") }}
                                    {{ t("nav.categories") }}
                                </option>
                                <option value="delete">
                                    {{ t("common.delete") }}
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    $t(
                                                        "adminAplikasi.categoryDetail.categoryCode"
                                                    )
                                                }}: {{ category.code }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <button
                                            ...
                                            :title="
                                                category.status === 'active'
                                                    ? t(
                                                          'modal.categoryModal.deactivate'
                                                      )
                                                    : t(
                                                          'modal.categoryModal.activate'
                                                      )
                                            "
                                        >
                                            <svg
...
const selectedApplication = computed(() => {
    ...
    return props.applications.find(
        (app) => app.id == currentApplicationId.value
    );
});
...
const loadCategories = () => {
    if (!currentApplicationId.value) {
        ...
        router.get(
            route("admin-aplikasi.categories.index"),
            {},
            {
                preserveState: false,
                preserveScroll: true,
...
const executeBulkAction = () => {
    ...
    if (bulkAction.value === "delete") {
        if (
            confirm(
                t("adminAplikasi.kategoriManagement.confirmBulkDelete", {
...
const toggleCategoryStatus = (category) => {
    ...
    if (
        confirm(
            t("common.areYouSure") + ` ${action} ` + t("nav.categories") + "?"
        )
    ) {
        router.post(
            route("admin-aplikasi.categories.update-status", category.id),
            {
                status: newStatus,
            }
        );
...
const deleteCategory = (category) => {
    if (
        confirm(
            t("adminAplikasi.kategoriManagement.confirmDelete", { name: category.name })
        )
    ) {
...
const exportCategories = () => {
    ...
    window.open(
        route("admin-aplikasi.categories.export") + "?" + params.toString(),
        "_blank"
    );
};
