<template>
    <AppLayout role="admin-aplikasi">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    >
                        <svg
                            class="w-5 h-5 mr-2"
                            :class="healthCheckLoading ? 'animate-spin' : ''"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                        ...
                        {{ healthCheckLoading ? $t("common.processing") : $t("common.healthCheck") }}
                    </button>
                    <button
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            />
            <StatCard
                :title="$t('adminAplikasi.applicationDetail.version')"
                :value="
                    application.version || application.current_version || 'N/A'
                "
                icon="🔢"
                color="blue"
            />
            <StatCard
                :title="
                    $t('adminAplikasi.applicationManagement.stats.totalTickets')
                "
            ...
            />
            <StatCard
                :title="$t('adminAplikasi.categoryDetail.healthScore')"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            <h3 class="text-lg font-semibold mb-4">
                                {{
                                    $t(
                                        "adminAplikasi.categoryDetail.categoryDetails"
                                    )
                                }}
                            </h3>
                            <dl class="space-y-3">
                                ...
                                <div>
                                    <dt class="text-sm text-gray-600">
                                        {{
                                            $t(
                                                "adminAplikasi.applicationDetail.criticality"
                                            )
                                        }}
                                    </dt>
                                    <dd>
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            <h3 class="text-lg font-semibold mb-4">
                                {{
                                    $t(
                                        "adminAplikasi.categoryDetail.performanceMetrics"
                                    )
                                }}
                            </h3>
                            <dl class="space-y-3">
                                <div v-if="healthMetrics.uptime_percentage">
                                    <dt class="text-sm text-gray-600">
                                        {{ $t("adminAplikasi.applicationDetail.uptime") }}
                                    </dt>
                                    <dd
                                        class="text-sm font-medium text-gray-900"
                                    >
                                        {{ healthMetrics.uptime_percentage }}%
                                    </dd>
                                </div>
                                <div v-if="healthMetrics.response_time_avg">
                                    <dt class="text-sm text-gray-600">
                                        {{ $t("adminAplikasi.applicationDetail.avgResponseTime") }}
                                    </dt>
                                    <dd
                                        class="text-sm font-medium text-gray-900"
                                    >
                                ...
                                <div v-if="healthMetrics.error_rate">
                                    <dt class="text-sm text-gray-600">
                                        {{ $t("adminAplikasi.applicationDetail.errorRate") }}
                                    </dt>
                                    <dd
                                        class="text-sm font-medium text-gray-900"
                                    >
                                ...
                                <div v-if="application.current_users !== null">
                                    <dt class="text-sm text-gray-600">
                                        {{
                                            $t(
                                                "adminAplikasi.applicationDetail.currentUsers"
                                            )
                                        }}
                                    </dt>
                                    <dd
                                    ...
                                    >
                                        ...
                                        {{
                                            ...
                                            $t(
                                                "adminAplikasi.applicationDetail.unlimited"
                                            )
                                        }}
                                    </dd>
                                </div>
                                <div v-if="healthMetrics.last_health_check">
                                    <dt class="text-sm text-gray-600">
                                        {{ $t("adminAplikasi.applicationDetail.lastHealthCheck") }}
                                    </dt>
                                    <dd
                                        class="text-sm font-medium text-gray-900"
                                    >
                                        {{
                                            formatDateTime(
                                                healthMetrics.last_health_check
                                            )
                                        }}
                                    </dd>
                                </div>
                ...
                <div v-if="activeTab === 'tickets'">
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold mb-4">
                            {{
                                $t(
                                    "adminAplikasi.categoryDetail.ticketStatistics"
                                )
                            }}
                        </h3>
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                            <div class="bg-gray-50 rounded-lg p-4 text-center">
                                ...
                                <div class="text-sm text-gray-600">{{ $t('adminAplikasi.applicationDetail.totalLabel') }}</div>
                            </div>
                            <div
                    ...
                    <div class="overflow-x-auto">
                        <h3 class="text-lg font-semibold mb-4">
                            {{ $t("dashboard.adminAplikasi.recentTickets") }}
                        </h3>
                ...
                <div v-if="activeTab === 'categories'">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        >
                            {{
                                $t(
                                    "adminAplikasi.applicationManagement.actions.manageCategories"
                                )
                            }}
                            →
                        </Link>
...
const tabs = [
    ...
    { id: "categories", label: t("adminAplikasi.categoryDetail.tabs.categories") },
];
...
const performHealthCheck = () => {
    ...
    router.post(
        `/admin-aplikasi/applications/${props.application.id}/health-check`,
        {},
        {
            onFinish: () => {
