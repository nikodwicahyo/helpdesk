<template>
    <AppLayout role="teknisi">
                ...
                <div class="flex-1">
                    ...
                    >
                        <div class="flex items-center">
                            ...
                            ></div>
                            <span>{{
                                t("dashboard.teknisi.ticketsInProgress", {
                        ...
                        <div class="flex items-center">
                            ...
                            <span>{{
                                t(
                                    "dashboard.teknisi.resolutionRatePercentage",
                                    { rate: performance?.resolution_rate || 0 }
                                )
                            }}</span>
                        </div>
                    </div>
        ...
        <!-- Performance Stats -->
        <div
            class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-5 mb-6"
        >
            <!-- Assigned Tickets Card -->
            <div
                class="bg-white rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 group"
            >
                <div class="flex items-start justify-between mb-3">
                    <div
                        class="w-11 h-11 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300"
                    >
                        <svg
                    ...
                    <span
                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-blue-50 text-blue-700 border border-blue-200"
                    >
                        {{ $t("status.active") }}
                    </span>
                </div>
                <div>
                    ...
                    >
                        {{ $t("dashboard.teknisi.assignedTickets") }}
                    </h3>
            ...
            <!-- In Progress Card -->
            <div
                class="bg-white rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 relative overflow-hidden group"
            >
                <div
                    class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full -mr-12 -mt-12 opacity-50"
                ></div>
                <div
                    class="flex items-start justify-between mb-3 relative z-10"
                >
                    <div
                        class="w-11 h-11 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300"
                    >
                        <svg
                            class="w-5 h-5 text-white"
                            fill="none"
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        class="flex items-center px-2 py-0.5 rounded-full text-xs font-semibold"
                        :class="
                            stats.resolved_today_trend > 0
                ...
                <div class="relative z-10">
                    ...
                    >
                        ...
                        {{ $t("dashboard.teknisi.vsYesterday") }}
                    </p>
                </div>
            </div>
            ...
            >
                <div
                    class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-cyan-100 to-teal-100 rounded-full -mr-12 -mt-12 opacity-50"
                ></div>
                <div
                    class="flex items-start justify-between mb-3 relative z-10"
                >
                    <div
                        class="w-11 h-11 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300"
                    >
                        <svg
                            class="w-5 h-5 text-white"
                            fill="none"
                    ...
                    <span
                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-cyan-50 text-cyan-700 border border-cyan-200"
                    >
                        {{ $t("dashboard.teknisi.avg") }}
                    </span>
                </div>
                <div class="relative z-10">
                    <h3
                    ...
                    >
                        {{
                            $t("dashboard.teknisi.avgResolutionTime") ||
                            "Avg Resolution"
                        }}
                    </h3>
                    <div class="mt-1 flex items-baseline">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500">{{
                            $t("dashboard.teknisi.hours") || "h"
                        }}</span>
                    </div>
                    <p class="mt-1 text-xs text-gray-500">
                        {{ $t("dashboard.teknisi.perTicket") || "per ticket" }}
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <div class="relative z-10">
                    <h3
                        class="text-xs font-medium text-gray-500 uppercase tracking-wide"
                    >
                        {{ $t("dashboard.teknisi.averageRating") }}
                    </h3>
                    <div class="mt-1 flex items-baseline">
                        <p class="text-3xl font-bold text-gray-900">
                            <AnimatedNumber
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        {{ $t("dashboard.teknisi.userSatisfaction") }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                    <h3 class="text-sm font-semibold text-red-800">
                        {{
                            $t("dashboard.teknisi.urgentAttention") ||
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                >
                                    <option value="all">
                                        {{ $t("dashboard.teknisi.allTasks") }}
                                    </option>
                                    <option value="urgent">
                                        {{ $t("dashboard.teknisi.urgentOnly") }}
                                    </option>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <span
                                                        v-if="isOverdue(ticket)"
                                                        class="px-1.5 py-0.5 text-xs font-medium rounded bg-red-100 text-red-800"
                                                    >
                                                        SLA
                                                    </span>
                                                    <span
                                            ...
                                            >
                                                {{
                                                    $t(
                                                        "dashboard.teknisi.startWorking"
                                                    )
                                                }}
                                            </button>
                                        </div>
                                    ...
                                    <template #item="{ element: ticket }">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span>{{
                                                    $t(
                                                        "dashboard.teknisi.waitingResponse"
                                                    )
                                                }}</span>
                                            </div>
                                            <button
            ...
            <div class="space-y-6 sm:space-y-8">
                ...
                >
                    <div
                        class="p-5 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-100"
                    >
                        <div class="flex items-center space-x-3">
                            <div
                        ...
                        <div class="group">
                            ...
                            >
                                <span
                                    ...
                                    >{{
                                        $t("dashboard.teknisi.resolutionRate")
                                    }}</span
                                >
                                <span
                                    class="text-sm font-semibold"
                                    :class="
                                        performance.resolution_rate >= 80
                                            ? 'text-green-600'
                                            : performance.resolution_rate >= 60
                                            ? 'text-amber-600'
                                            : 'text-red-600'
                                    "
                                >
                            ...
                            >
                                <div
                                    ...
                                    "
                                    :style="{
                                        width: `${performance.resolution_rate}%`,
                                    }"
                                ></div>
                            </div>
                        </div>
                        ...
                        >
                            <div class="flex items-center space-x-2">
                                ...
                                <span
                                    ...
                                    >{{
                                        $t(
                                            "dashboard.teknisi.avgResolutionTime"
                                        ) || "Avg Resolution Time"
                                    }}</span
                                >
                            </div>
                        ...
                        >
                            <div class="flex items-center space-x-2">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-700"
                                    >{{
                                        $t("dashboard.teknisi.avgResponseTime")
                                    }}</span
                                >
                            </div>
                            <span class="text-sm font-semibold text-gray-900">
                        ...
                        >
                            <div class="flex items-center space-x-2">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-700"
                                    >{{
                                        $t("dashboard.teknisi.ticketsThisWeek")
                                    }}</span
                                >
                            </div>
                            <span class="text-sm font-semibold text-gray-900">{{
                                performance.tickets_this_week
                            }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between py-2">
                            <div class="flex items-center space-x-2">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-700"
                                    >{{
                                        $t("dashboard.teknisi.userRating")
                                    }}</span
                                >
                            </div>
                ...
                >
                    <div
                        class="p-5 bg-gradient-to-r from-purple-50 to-pink-50 border-b border-gray-100"
                    >
                        <div class="flex items-center space-x-3">
                            <div
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        >
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                {{
                                    $t("dashboard.teknisi.noSpecializationsYet")
                                }}
                            </p>
                        </div>
                        <div
                ...
                >
                    <div
                        class="p-5 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100"
                    >
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-9 h-9 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center shadow-md"
                            >
                                <svg
                                    class="w-5 h-5 text-white"
                                    fill="none"
                    ...
                    >
                        ...
                        <p class="text-sm font-medium text-gray-500">
                            {{ $t("dashboard.teknisi.noFeedbackYet") }}
                        </p>
                        <p class="text-xs text-gray-400 mt-1">
                            {{ $t("dashboard.teknisi.feedbackDescription") }}
                        </p>
                    </div>
...
const initializeKanban = () => {
    ...
    kanbanColumns.value = {
        ...
        in_progress: tickets.filter(
            (ticket) => ticket.status === "in_progress" && filterTicket(ticket)
        ),
        waiting_response: tickets.filter(
            (ticket) =>
        ...
        resolved: tickets.filter(
            (ticket) => ticket.status === "resolved" && filterTicket(ticket)
        ),
    };
};
...
const onDragEnd = async (evt) => {
    ...
    try {
        ...
        const response = await axios.post(
            `/teknisi/tickets/${ticketId}/update-status`,
            {
                status: newStatus,
            }
        );
