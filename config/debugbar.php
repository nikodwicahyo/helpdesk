...
return [
    ...
    'except' => [
        'telescope*',
        'horizon*',
        'api/auth/*', // Exclude auth API routes for security
    ],
     ...
     */
    'storage' => [
        'enabled'    => env('DEBUGBAR_STORAGE_ENABLED', false), // DISABLED for security - use headers/session only
        'open'       => env('DEBUGBAR_OPEN_STORAGE'), // bool/callback - DISABLED for production security
    ...
    */
    ...
    'collectors' => [
        ...
        'route'           => env('DEBUGBAR_COLLECTORS_ROUTE', true),            // Current route information - ENABLED for helpdesk debugging
        'auth'            => env('DEBUGBAR_COLLECTORS_AUTH', true),             // Display Laravel authentication status - ENABLED for multi-role auth
        'gate'            => env('DEBUGBAR_COLLECTORS_GATE', true),             // Display Laravel Gate checks
        'session'         => env('DEBUGBAR_COLLECTORS_SESSION', true),          // Display session data - ENABLED for helpdesk session debugging
        ...
        'models'          => env('DEBUGBAR_COLLECTORS_MODELS', true),           // Display models - ENABLED for helpdesk model debugging
        'livewire'        => env('DEBUGBAR_COLLECTORS_LIVEWIRE', true),         // Display Livewire (when available)
        'jobs'            => env('DEBUGBAR_COLLECTORS_JOBS', true),             // Display dispatched jobs - ENABLED for helpdesk notifications
    ...
    'options' => [
        ...
        'auth' => [
            ...
            'show_guards' => env('DEBUGBAR_OPTIONS_AUTH_SHOW_GUARDS', true), // Show the guards that are used - ENABLED for multi-role debugging
        ],
        'gate' => [
        ...
        'db' => [
            ...
            'exclude_paths'     => [       // Paths to exclude entirely from the collector
                'vendor/laravel/framework/src/Illuminate/Session', // Exclude sessions queries for cleaner output
            ],
            ...
            'timeline'          => env('DEBUGBAR_OPTIONS_DB_TIMELINE', true),   // Add the queries to the timeline - ENABLED for helpdesk debugging
            ...
            'hints'             => env('DEBUGBAR_OPTIONS_DB_HINTS', true),          // Show hints for common mistakes - ENABLED for development
            'show_copy'         => env('DEBUGBAR_OPTIONS_DB_SHOW_COPY', true),       // Show copy button next to the query,
            'slow_threshold'    => env('DEBUGBAR_OPTIONS_DB_SLOW_THRESHOLD', 100), // Only track queries that last longer than 100ms - HELPDESK OPTIMIZATION
            'memory_usage'      => env('DEBUGBAR_OPTIONS_DB_MEMORY_USAGE', false),   // Show queries memory usage
            'soft_limit'       => (int) env('DEBUGBAR_OPTIONS_DB_SOFT_LIMIT', 50),  // After the soft limit, no parameters/backtrace are captured - REDUCED FOR HELPDESK
            'hard_limit'       => (int) env('DEBUGBAR_OPTIONS_DB_HARD_LIMIT', 200),  // After the hard limit, queries are ignored - REDUCED FOR HELPDESK
        ],
        'mail' => [
        ...
        'views' => [
            ...
            'inertia_pages' => env('DEBUGBAR_OPTIONS_VIEWS_INERTIA_PAGES', 'js/Pages'),  // Path for Inertia views - CONFIGURED FOR HELPDESK
            'exclude_paths' => [    // Add the paths which you don't want to appear in the views
                'vendor/filament',  // Exclude Filament components by default
                'vendor/barryvdh/laravel-debugbar', // Exclude debugbar itself
            ],
        ],
        'route' => [
        ...
        'session' => [
            'hiddens' => [
                ...
                '_previous',
                '_flash',
            ], // Hides sensitive values using array paths - ENHANCED FOR HELPDESK SECURITY
        ],
        'symfony_request' => [
     ...
     */
    'route_middleware' => [
        'auth', // Require authentication for debugbar routes
    ],
